                    ...
                    <div className="tab-content" id="v-pills-tabContent">
                      <Fade duration={500} delay={200}>
                        ...
                        >
                          <div className="tab-list row">
                            <div className="col">
                              <h6 className="gi-col-title">لباس ها</h6>
                            ...
                            <div className="col">
                              <h6 className="gi-col-title">کفش</h6>
                              <ul className="cat-list">
                      ...
                      <Fade duration={500} delay={200}>
                        ...
                        >
                          <div className="tab-list row">
                            <div className="col">
                              <h6 className="gi-col-title">جواهرات</h6>
                              <ul className="cat-list">
                      ...
                      <Fade duration={500} delay={200}>
                        ...
                        >
                          <div className="tab-list row">
                            <div className="col">
                              <h6 className="gi-col-title">عطر</h6>
                              <ul className="cat-list">
                            ...
                            <div className="col">
                              <h6 className="gi-col-title">لوازم آرایشی</h6>
                              <ul className="cat-list">
                    ...
                    <div className="row gi-location-wrapper">
                      <ul className="loc-grid">
                        ...
                        <li className="loc-list">
                          <i className="fi fi-rr-map-marker-plus"></i>
                          <span className="gi-detail">تهران</span>
                        </li>
                        <li className="loc-list">
                          <i className="fi fi-rr-map-marker-plus"></i>
                          <span className="gi-detail">لرستان</span>
                        </li>
                        <li className="loc-list">
                          <i className="fi fi-rr-map-marker-plus"></i>
                          <span className="gi-detail">شیراز</span>
                        </li>
                        <li className="loc-list">
                          <i className="fi fi-rr-map-marker-plus"></i>
                          <span className="gi-detail">همدان</span>
                        </li>
                        <li className="loc-list">
                          <i className="fi fi-rr-map-marker-plus"></i>
                          <span className="gi-detail">اصفهان</span>
                        </li>
                      </ul>
                    </div>
                  </div>
