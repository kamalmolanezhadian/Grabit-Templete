            ...
            >
              <div className="gi-category-menu">
                <div className="gi-category-toggle">
                  ...
                  <span className="text">همه دسته بندی ها</span>
                  <i
                    ...
                    <TabList>
                      ...
                      >
                        <Tab>
                          ...
                          >
                            <i className="fi-rr-cupcake"></i>لبنیات و نانوایی
                          </button>
                        </Tab>
                        <Tab>
                          <button
                          ...
                          >
                            <i className="fi fi-rs-apple-whole"></i>میوه ها و سبزی ها
                          </button>
                        </Tab>
                        <Tab>
                          <button
                          ...
                          >
                            <i className="fi fi-rr-popcorn"></i>میان وعده و ادویه
                          </button>
                        </Tab>
                        <Tab>
                          <button
                          ...
                          >
                            <i className="fi fi-rr-drink-alt"></i>آبمیوه و نوشیدنی{" "}
                          </button>
                        </Tab>
                      </div>
                    </TabList>
                    <div className="tab-content" id="v-pills-tabContent">
                      <Fade duration={500} delay={200}>
                        ...
                        >
                          <div className="tab-list row">
                            <div className="col">
                              <h6 className="gi-col-title">لبنیات</h6>
                            ...
                            <div className="col">
                              <h6 className="gi-col-title">نانوایی</h6>
                              <ul className="cat-list">
                      ...
                      <Fade duration={500} delay={200}>
                        ...
                        >
                          <div className="tab-list row">
                            <div className="col">
                              <h6 className="gi-col-title">میوه ها</h6>
                              <ul className="cat-list">
                                {fruits.map((data, index) => (
                                  <li key={index}>
                                    <Link href={data.href}>{data.name}</Link>
                            ...
                            <div className="col">
                              <h6 className="gi-col-title">سبزی</h6>
                              <ul className="cat-list">
                                {fruits.map((data, index) => (
                                  <li key={index}>
                                    <Link href={data.href}>{data.name}</Link>
                      ...
                      <Fade duration={500} delay={200}>
                        ...
                        >
                          <div className="tab-list row">
                            <div className="col">
                              <h6 className="gi-col-title">تنقلات</h6>
                              <ul className="cat-list">
                            ...
                            <div className="col">
                              <h6 className="gi-col-title">ادویه</h6>
                              <ul className="cat-list">
                      ...
                      <Fade duration={500} delay={200}>
                        ...
                        >
                          <div className="tab-list row">
                            <div className="col">
                              <h6 className="gi-col-title">آبمیوه</h6>
                              <ul className="cat-list">
                            ...
                            <div className="col">
                              <h6 className="gi-col-title">نوشابه</h6>
                              <ul className="cat-list">
                  ...
                  <div className="col-md-12 align-self-center">
                    <div className="gi-main-menu">
                      <ul>
                        ...
                        <li className="dropdown drop-list">
                          <Link href="" className="dropdown-arrow">
                            محصولات<i className="fi-rr-angle-small-right"></i>
                          </Link>
                          <ul className="sub-menu">
                        ...
                        <li className="dropdown drop-list">
                          <Link href="" className="dropdown-arrow">
                            صفحات<i className="fi-rr-angle-small-right"></i>
                          </Link>
                          <ul className="sub-menu">
