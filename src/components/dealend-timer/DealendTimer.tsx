    ...
    <>
      ...
      <div className="dealend-timer">
          <div className="time-block">
            <div className="time">{toPersianNum(timeLeft.days)}</div>
            <span className="day">روز</span>
          </div>
          <div className="time-block">
            <div className="time">{toPersianNum(timeLeft.hours)}</div>
            <span className="dots">:</span>
          </div>
          <div className="time-block">
            <div className="time">{toPersianNum(timeLeft.minutes)}</div>
            <span className="dots">:</span>
          </div>
          <div className="time-block">
            <div className="time">{toPersianNum(timeLeft.seconds)}</div>
          </div>
        </div>
      </div>
    </>
