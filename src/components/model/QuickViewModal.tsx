                  ...
                  <div className="quickview-pro-content">
                    ...
                    <div className="gi-quickview-price">
                      <span className="new-price">
                        {formatNumber(data.newPrice * data.quantity)}
                      </span>
                      <span className="old-price">${formatNumber(data.oldPrice)}</span>
                    </div>
                    ...
                    <div className="gi-quickview-qty">
                      ...
                      <div className="gi-quickview-cart ">
                        <button
                          ...
                          className="gi-btn-1"
                        >
                          <i className="fi-rr-shopping-basket"></i> اضافه کردن به سبد خرید
                        </button>
                      </div>
                    </div>
                  </div>
