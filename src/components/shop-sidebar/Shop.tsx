            ...
            <div className="col-md-6 gi-sort-select">
              <div className="gi-select-inner">
                ...
                >
                  ...
                  <option value="1">مکان</option>
                  <option value="2">ارتباط</option>
                  <option value="3">نام، A تا Z</option>
                  <option value="4">نام، Z تا A</option>
                  <option value="5">قیمت، کم به بالا</option>
                  <option value="6">قیمت، بالا به پایین</option>
                </select>
              </div>
            </div>
          </div>
            ...
            >
              ...
              {!data.data.length ? (
                ...
                <div className="gi-pro-pagination">
                  <span>
                    پیدا شد {toPersianNum((currentPage - 1) * itemsPerPage + 1)}-
                    {toPersianNum(Math.min(currentPage * itemsPerPage, data.totalItems))} از{" "}
                    {toPersianNum(data.totalItems)} مورد
                  </span>
