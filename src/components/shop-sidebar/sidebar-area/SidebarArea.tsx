...
const SidebarArea = ({
  ...
  if (error) return <div>خطا در بارگزاری محصولات</div>;
          ...
          <div className="gi-sidebar-wrap">
            ...
            <div className="gi-sidebar-block">
              <div className="gi-sb-title">
                <div
                  style={{ display: "flex", justifyContent: "space-evenly" }}
                >
                  <h3 className="gi-sidebar-title">وزن</h3>
                  <div
                    style={{ cursor: "pointer" }}
                      ...
                      <li key={index}>
                        <div className="gi-sidebar-block-item">
                          <input
                            ...
                            type="checkbox"
                          />
                          <Link href="/">{toPersianNum(data.weight)}</Link>
                          <span className="checked"></span>
                        </div>
                      </li>
                    ))}
            ...
            <div className="gi-sidebar-block color-block gi-sidebar-block-clr">
              <div
                ...
                className="gi-sb-title"
              >
                <h3 className="gi-sidebar-title">رنگ</h3>
                <div
                  style={{ cursor: "pointer" }}
