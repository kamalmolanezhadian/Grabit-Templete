...
const RegisterPage = ({ onSuccess = () => {}, onError = () => {} }) => {
  ...
  const schema = yup.object().shape({
    ...
    country: yup.string().required("کشور مورد نیاز است"),
    state: yup.string().required("استان مورد نیاز است"),
    city: yup.string().required("شهر مورد نیاز است"),
    postCode: yup.string().required("کد پستی الزامی است"),
  });
