          ...
          <>
            ...
            {posts.length === 0 ? (
              <span className="gi-pro-content cart-pro-title">
                تاریخچه وبلاگی یافت نشد
              </span>
            ) : (
              <div className="gi-pro-pagination">
                <span>
                در حال نمایش {toPersianNum((currentPage - 1) * itemsPerPage + 1)}-
                  {toPersianNum(Math.min(currentPage * itemsPerPage, posts.length))} از{" "}
                  {toPersianNum(posts.length)} مورد
                </span>
                <Paginantion
        ...
        <div className="gi-blog-search">
          <div className="gi-blog-search-form">
            <input
              ...
              placeholder="وبلاگ ما را جستجو کنید"
              type="text"
              value={searchInput}
