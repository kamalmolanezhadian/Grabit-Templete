...
const SidebarCategory = ({
  ...
  const priceRanges = [
    { name: "زیر 500000", min: 0, max: 50 },
    { name: "500000 تا 1000000", min: 50, max: 100 },
    { name: "100000000 تا 100000000", min: 100, max: 200 },
    { name: "بالای  100000000", min: 200, max: Infinity },
  ];
        ...
        <div id="shop_sidebar">
          <div style={{ backgroundColor: "#fff" }} className="gi-sidebar-wrap">
            ...
            <div className="gi-sidebar-block">
              ...
              >
                <h3 className="gi-sidebar-title">دسته بندی</h3>
                <div
            ...
            <div className="gi-sidebar-block">
              <div
                ...
                className="gi-sb-title"
              >
                <h3 className="gi-sidebar-title">برند</h3>
                <div
                  style={{ cursor: "pointer" }}
            ...
            <div className="gi-sidebar-block">
              <div
                ...
                className="gi-sb-title"
              >
                <h3 className="gi-sidebar-title">قیمت</h3>
                <div
                  style={{ cursor: "pointer" }}
            ...
            <div className="gi-sidebar-block">
              <div
                ...
                className="gi-sb-title"
              >
                <h3 className="gi-sidebar-title">برچسب ها</h3>
                <div
                  style={{ cursor: "pointer" }}
            ...
            <div className="banner-block-side banner-block">
              <div className="banner-content">
                <div className="banner-text">
                  ...
                  برترین محصولات ما اکنون آن را بررسی می کنند
                  </span>
                </div>
                <a
