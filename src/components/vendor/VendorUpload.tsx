                ...
                <div className="gi-vendor-card-body">
                  <div className="gi-vendor-upload-detail">
                    <form onSubmit={handleSubmit} className="row">
                      ...
                      <Col md={6}>
                        <label className="form-label">دسته ها را انتخاب کنید</label>
                        <select
                          name="category"
                          id="category"
                          ...
                          onChange={handleChange}
                        >
                          <optgroup defaultValue="" label="مد">
                          <option value="t-shirt">تی شرت</option>
                          <option value="dress">لباس</option>
                          </optgroup>
                          <optgroup defaultValue="" label="مبلمان">
                          <option value="table">جدول</option>
                            <option value="sofa">مبل</option>
                          </optgroup>
                          <optgroup defaultValue="" label="الکترونیکی">
                          <option value="phone">من تلفن</option>
                          <option value="laptop">لپ تاپ</option>
                          </optgroup>
                        </select>
                      </Col>
                      <Col md={12}>
                      <label className="form-label">مرتب کردن توضیحات</label>
                        <textarea
                      ...
                      <label className="form-label">رنگ‌ها</label>
                      ...
                      <Col md={12}>
                      <label className="form-label">جزئیات کامل</label>
                        <textarea
                          id="fullDetail"
                          name="fullDetail"
                      ...
                      <label className="form-label">
                          برچسب های محصول{" "}
                          <span>( برای جدا کردن برچسب ها تایپ کرده و کاما بسازید)</span>
                        </label>
